                  ...
                  <div class="overlay-container">
                    ...
                    <div id="overlay-left" class="overlay-panel overlay-left">
                        ...
                        <div class="overlay-panel overlay-right">
                          <h1>Ready to begin learning?</h1>
                          <p>Sign up to enjoy the benefits of Brightpath.</p>
      ...
      <div class="container">
        <div class="row mb-5 justify-content-center">
          <div class="col-lg-7 text-center"  data-aos="fade-up" data-aos-delay="">
            ...
            <p>The best courses avaliable in an easy to learn and accessible enviroment.</p>
          </div>
        </div>
        <div class="row mb-5 align-items-center">
          ...
          <div class="col-lg-4 ml-auto" data-aos="fade-up" data-aos-delay="200">
            <h2 class="text-black mb-4">Education Shouldn't be a Chore</h2>
            <p class="mb-4">Education is an art form which can change generations.</p>

            <div class="d-flex align-items-center custom-icon-wrap mb-3">
              <span class="custom-icon-inner mr-3"><span class="icon icon-graduation-cap"></span></span>
              <div><h3 class="m-0">2,105 Yearly Graduates</h3></div>
            </div>

            <div class="d-flex align-items-center custom-icon-wrap">
              <span class="custom-icon-inner mr-3"><span class="icon icon-university"></span></span>
              <div><h3 class="m-0">26 Universities Worldwide</h3></div>
            </div>
        ...
        <div class="row mb-5 align-items-center">
          ...
          <div class="col-lg-4 mr-auto order-2 order-lg-1" data-aos="fade-up" data-aos-delay="200">
            <h2 class="text-black mb-4">Strive for Excellence</h2>
            <p class="mb-4">Excellence in this case being your success.</p>
        ...
        <div class="row mb-5 align-items-center">
          ...
          <div class="col-lg-4 ml-auto" data-aos="fade-up" data-aos-delay="200">
            <h2 class="text-black mb-4">Education is Neverending</h2>
            <p class="mb-4">To live to to learn.</p>
      ...
      <div class="container">
        ...
        <div class="row mb-5 justify-content-center">
          <div class="col-lg-7 mb-5 text-center"  data-aos="fade-up" data-aos-delay="">
            ...
            <p class="mb-5">Some of our teachers include:</p>
          </div>
        </div>
        ...
        <div class="row">
          ...
          <div class="col-md-6 col-lg-4 mb-4" data-aos="fade-up" data-aos-delay="100">
            <div class="teacher text-center">
              ...
              <div class="py-2">
                ...
                <p>Made over 100 websites for Forbes 500 companies with years of experience.</p>
              </div>
            </div>
          </div>
          ...
          <div class="col-md-6 col-lg-4 mb-4" data-aos="fade-up" data-aos-delay="200">
            <div class="teacher text-center">
              ...
              <div class="py-2">
                <h3 class="text-black">Abidi Chen</h3>
                <p class="position">AI Teacher</p>
                <p>Over 20 years of experience in A.I, Worked at OpenAI.</p>
              </div>
            </div>
          </div>
          ...
          <div class="col-md-6 col-lg-4 mb-4" data-aos="fade-up" data-aos-delay="300">
            <div class="teacher text-center">
              ...
              <div class="py-2">
                <h3 class="text-black">Zewali Mohammed</h3>
                <p class="position">IOT Teacher</p>
                <p>Leading expert in the domain of IOT, including projects for Amazon.</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="container">
        <div class="row justify-content-center align-items-center">
          <div class="col-md-8 text-center testimony">
            ...
            <h3 class="mb-4">John Warden</h3>
            <blockquote>
              <p>&ldquo; Studing via Brightpath has made my learning journey organised and in some cases more enjoyable than conventional methods. Try it! You won't regret it. &rdquo;</p>
            </blockquote>
          </div>
        </div>
      </div>
        ...
        <div class="row">
          <div class="col-lg-4 ml-auto align-self-start"  data-aos="fade-up" data-aos-delay="100">
            ...
            <div class="p-4 rounded bg-white why-choose-us-box">
              ...
              <div class="d-flex align-items-center custom-icon-wrap custom-icon-light mb-3">
                <div class="mr-3"><span class="custom-icon-inner"><span class="icon icon-graduation-cap"></span></span></div>
                <div><h3 class="m-0">Top Professors in The World</h3></div>
              </div>
              ...
              <div class="d-flex align-items-center custom-icon-wrap custom-icon-light mb-3">
                <div class="mr-3"><span class="custom-icon-inner"><span class="icon icon-graduation-cap"></span></span></div>
                <div><h3 class="m-0">Feedback with Experts</h3></div>
              </div>

              <div class="d-flex align-items-center custom-icon-wrap custom-icon-light">
                <div class="mr-3"><span class="custom-icon-inner"><span class="icon icon-university"></span></span></div>
                <div><h3 class="m-0">Accredited by ISO</h3></div>
              </div>
      ...
      <div class="container">
        ...
        <div class="row justify-content-center">
          <div class="col-md-7">
            ...
            <p class="mb-5">Suggestions and complaints are welcome.</p>
            ...
            if(filter_has_var(INPUT_POST, 'submit')){
              ...
              if(!empty($email) && !empty($name) && !empty($message) && !empty($subject)){
                ...
                if(filter_var($email, FILTER_VALIDATE_EMAIL) === false){
                  ...
                  // Passed
                  $toEmail = 'support@brightpath.com';
